	...
	Install: function(plugin_info) {
		...
		return Promise.resolve({ 
			then: function(resolve, reject) {
				...
				if(success) {
					installedPlugins[pluginName] = require(pluginsDir+pluginName);
...
var requireCustom = function (file) {
	var module = {exports: {yippi: "hej"}};
	Context.Expose('module', module);
	Context.Expose('AAA', module);
	Context.RunFile(file);
